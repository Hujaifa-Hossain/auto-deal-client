        ...
        <div className="row gx-5">
          <div className="col-lg-6">
            <div className="p-3">
              <div className="card mb-3 bg-dark">
                <img src={car?.image} className="card-img-top rounded" alt="..." style={{height: '350px'}}/>
                <div className="card-body">
                  <h5 className="card-title text-warning">{car?.name}</h5>
          ...
          <div className="col-lg-6">
            <div className="p-3 m-4">
              <h5 className="text-center text-warning">Shipment Form</h5>

              <form onSubmit={handleSubmit(onSubmit)}>
                {/* register your input into the hook by invoking the "register" function */}
                <input
                  className="p-2 px-4 m-1 w-100 rounded"
                ...
                <br />
                <input
                  className="btn btn-warning py-2 px-5 m-1 w-100 rounded"
                  type="submit"
                  value="PLACE ORDER"
                />
              </form>
